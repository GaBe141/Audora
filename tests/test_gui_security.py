...
def test_run_action_returns_error_when_admin_action_rejected(monkeypatch):
    monkeypatch.setenv("AUDORA_GUI_ENABLE_ADMIN_ACTIONS", "0")

    with patch.object(gui_app.ctx, "triggered_id", "btn-validate"):
        status, output = gui_app.run_action(0, 0, 0, 1, "statistical")
