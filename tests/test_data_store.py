...
class TestExportToCsvSecurity:
    """CSV export must stay inside allowed directories and apply a row cap."""
    ...
    def test_export_writes_to_database_parent(self, data_store, sample_trends, temp_db_path):
        data_store.save_trends_bulk(sample_trends)
