...
from core.utils import safe_output_path, write_json
...
class SocialMusicDiscoveryEngine:
    ...
    def save_discovery_report(self, report: dict[str, Any], filepath: str | None = None) -> str:
        ...
        output_path = safe_output_path("data", filepath, allowed_suffixes={".json"})
        saved_path = write_json(output_path, report)
