...
import subprocess  # nosec B404 - this maintenance script runs static argument lists only.
import sys
...
def main() -> None:
    ...
    for file in files_to_fix:
        run_command([sys.executable, "-m", "ruff", "check", file, "--fix", "--unsafe-fixes"], f"Fixing {file}")
