"""Automated fix script for Audora lint and typing issues."""
...
def _display_command(cmd: list[str]) -> str:
    """Return shell-escaped command string for logs."""
    return " ".join(shlex.quote(part) for part in cmd)


def run_command(cmd: list[str], description: str) -> bool:
    """Run a command (without shell) and return success status."""
    print(f"  → {description}")
