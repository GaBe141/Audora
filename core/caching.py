...
class RedisCacheBackend(CacheBackend):
    ...
    def _serialize(self, value: Any) -> bytes:
        """Serialize cache value with a non-executable JSON envelope."""
    ...
    def _to_safe_envelope(self, value: Any) -> dict[str, Any]:
        """Convert supported cache values into JSON-safe typed envelopes."""
        try:
            import pandas as pd
        ...
        if pd is not None and isinstance(value, pd.DataFrame):
            return {"v": 2, "type": "pandas_dataframe", "value": value.to_json(orient="split")}
        ...
        return {"v": 2, "type": "json", "value": self._to_json_safe(value)}

    def _from_safe_envelope(self, envelope: dict[str, Any]) -> Any | None:
        """Restore a value from a supported JSON-safe typed envelope."""
    ...
    def _to_json_safe(self, value: Any) -> Any:
        """Normalize common scalar/container values into strict JSON-compatible data."""
...
class CacheManager:
    ...
    def set(self, key: str, value: Any, ttl: int | None = None) -> None:
        ...
        Args:
            key: Cache key
            value: JSON-compatible value, bytes, or pandas DataFrame to cache
