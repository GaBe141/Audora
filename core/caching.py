...
import logging
import os
import pickle  # nosec B403 - serialized payloads are HMAC-signed before deserialization
import time
...
class RedisCacheBackend(CacheBackend):
    ...
    def _deserialize(self, value: bytes) -> Any | None:
        ...
        try:
            ...
            return pickle.loads(payload)  # nosec B301 - payload integrity is verified via HMAC
