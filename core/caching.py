...
import logging
import os
import pickle  # nosec B403 - Redis cache payloads are HMAC-authenticated before loading.
import time
...
class RedisCacheBackend(CacheBackend):
    ...
    def _deserialize(self, value: bytes) -> Any | None:
        ...
        try:
            ...
            # nosec B301 - payload is authenticated with HMAC-SHA256 immediately above.
