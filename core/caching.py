...
class RedisCacheBackend(CacheBackend):
    ...
    def __init__(
        ...
        self._pool = ConnectionPool(
            ...
            decode_responses=False,  # Keep binary mode for safe cache payloads
        )
    ...
    def _serialize(self, value: Any) -> bytes:
        """Serialize cache value without executable formats."""
    ...
    def _normalize_json_payload(self, value: Any) -> Any:
        """Return a strict JSON-compatible representation or raise TypeError."""
        try:
            return json.loads(json.dumps(value, default=self._json_default, allow_nan=False))
    ...
    def _json_default(value: Any) -> Any:
        """Convert common scalar values from analysis libraries into JSON scalars."""
    ...
    def _delete_invalid_entry(self, key: str) -> None:
        """Delete a malformed cache entry after a rejected read."""
        try:
            self._client.delete(key)
        except Exception as e:
            logger.error(f"Redis delete error for invalid key {key}: {e}")

    def _safe_deserialize(self, key: str, value: bytes) -> Any | None:
        """Deserialize a cache entry and remove it when the payload is invalid."""
    ...
    def get(self, key: str) -> Any | None:
        ...
        try:
            ...
            if value is None:
                return None
            return self._safe_deserialize(key, value)
        except Exception as e:
