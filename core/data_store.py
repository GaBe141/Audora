...
class EnhancedMusicDataStore:
    ...
    def get_tracks_with_artists_bulk(
        ...
        # Create deterministic cache key from the input pairs.
        key_material = json.dumps(sorted(track_artist_pairs), ensure_ascii=True)
        pairs_digest = hashlib.sha256(key_material.encode("utf-8")).hexdigest()
