...
class EnhancedMusicDataStore:
    ...
    def get_tracks_with_artists_bulk(
        ...
        # Create a deterministic cache key across processes/runs.
        sorted_pairs = sorted(track_artist_pairs)
        pairs_json = json.dumps(sorted_pairs, ensure_ascii=False, separators=(",", ":"))
        pairs_digest = hashlib.sha256(pairs_json.encode("utf-8")).hexdigest()
