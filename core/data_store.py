...
class EnhancedMusicDataStore:
    ...
    def get_tracks_with_artists_bulk(
        ...
        # Use a deterministic cryptographic digest for stable cache keys.
        normalized_pairs = json.dumps(sorted(track_artist_pairs), separators=(",", ":"), ensure_ascii=True)
        cache_digest = hashlib.sha256(normalized_pairs.encode("utf-8")).hexdigest()
