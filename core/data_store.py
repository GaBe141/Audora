...
class EnhancedMusicDataStore:
    ...
    def _resolve_export_path(self, filepath: str) -> Path:
        """Confine CSV exports to the working tree, backup dir, or DB parent."""
    ...
    def export_to_csv(self, table: str, filepath: str, days: int | None = None) -> str:
        ...
        Export paths are confined and row count is capped.
        """
        ...
        with self.get_connection() as conn:
            if days:
                ...
                query = f"SELECT * FROM {table} ORDER BY created_at DESC LIMIT {self._MAX_EXPORT_ROWS}"
