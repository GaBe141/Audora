...
class EnhancedMusicDataStore:
    ...
    def get_tracks_with_artists_bulk(
        ...
        # Create deterministic cache key from sorted pairs.
        sorted_pairs = tuple(sorted(track_artist_pairs))
        pairs_payload = json.dumps(sorted_pairs, separators=(",", ":"), ensure_ascii=False)
