...
class EnhancedMusicDataStore:
    ...
    def _resolve_export_path(self, filepath: str) -> Path:
        """Confine CSV exports to the cwd, backup dir, or database directory."""
        ...
        if not any(self._is_within_directory(resolved, root) for root in allowed_roots):
    ...
    def export_to_csv(self, table: str, filepath: str, days: int | None = None) -> str:
        ...
        Export path is confined to trusted directories and row count is capped.
        """
