...
class EnhancedNotificationService:
    ...
    def _is_allowed_attachment_path(self, attachment_path: str) -> bool:
        """Confine email attachments to the project working tree."""
        try:
    ...
    async def _send_email(self, message: NotificationMessage) -> dict[str, Any]:
        ...
        try:
            ...
            if username and password and not use_tls:
                return {
                    "success": False,
                    "error": "Refusing to authenticate over unencrypted SMTP",
                }
        ...
        try:
            ...
            async with (
                ...
                if 300 <= response.status < 400:
                    ...
                    return {"success": False, "error": "Refusing to follow webhook redirect"}
