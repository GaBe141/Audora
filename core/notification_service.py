...
""",
    ...
    def _build_email_html(self, text_content: str) -> str:
        """Build a safe HTML email body from plain-text notification content."""
    ...
    async def _send_email(self, message: NotificationMessage) -> dict[str, Any]:
        ...
        try:
            ...
            msg.attach(MIMEText(self._build_email_html(text_content), "html"))
