...
class EnhancedNotificationService:
    ...
    def _is_allowed_attachment_path(self, path: Path) -> bool:
        ...
        try:
            ...
            if message.attachments:
                for attachment_path in message.attachments:
                    ...
                    if not path.exists() or not self._is_allowed_attachment_path(path):
                        self.logger.warning(
                    ...
                    with path.open("rb") as f:
                        ...
                        attachment.add_header(
                            "Content-Disposition",
                            f"attachment; filename= {self._sanitize_email_header(path.name)}",
                        )
